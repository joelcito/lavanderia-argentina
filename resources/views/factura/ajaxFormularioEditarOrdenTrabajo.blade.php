            ...
            <tbody class="text-gray-600 fw-semibold">
                ...
                @forelse ( $ordenesTrabajos as $ordenTrabajo)
                    ...
                    <tr>
                        ...
                        <td><input type="number" min="0.01" step="0.01" value="{{ $ordenTrabajo->peso }}" style="width: 100%"></td>
                        <td><input type="number" min="0.01" step="0.01" value="{{ $ordenTrabajo->precio }}" style="width: 100%"></td>
                        <td><input type="number" min="0.01" step="0.01" value="{{ $ordenTrabajo->subtotal }}" style="width: 100%"></td>
                        <td><input type="text" min="0.01" step="0.01" value="{{ $ordenTrabajo->observacion }}" style="width: 100%"></td>
                        <td><input type="number" min="0.01" step="0.01" value="{{ $ordenTrabajo->nro_ot }}" style="width: 100%"></td>
                    </tr>
                @empty
