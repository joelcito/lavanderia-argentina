        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header" id="kt_modal_add_user_header">
                    <h3 class="fw-bold">FORMULARIO DE NEVADO <span class="text-info" id="nombre_busqueda"></span></h3>
    ...
    <script>
        ...
        function guardarNombreTela(){
            let datos = $('#formularioNombreTela').serializeArray();
             $.ajax({
                url: "{{ route('nevado.guardarNevado') }}",
                method: "POST",
                data: datos,
                success: function(resultado) {
                    if (resultado.estado) {
        ...
        function eliminarNombreTela(nombre_tela, nombre) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ route('nevado.eliminarNevado') }}",
                        method: "POST",
